...
<div class="goodsmBox smBox" data-options="region:'center'" style="border:0">
	<div class="easyui-layout" data-options="fit:true">
		<div class="header" id="MoveListSearch" data-options="region:'north'" style="border:0">
			<p class="navBar mgB16">
				<a class="btnG btnBl" onclick="MoveListSearchBox()">搜索</a>
				<a class="btnG btnBl" onclick="formReset()">重置</a>
			</p>
		<table class="gList">
					<td><label for="" class="dib tar">移出货位号</label> <input
						class="easyui-validatebox combo"  name="locationNoOut"
						maxlength="20" /></td>
					<td>
		...
		<div class="center" data-options="region:'center'" style="border:0">
			<div class="easyui-layout" data-options="fit:true">
			    <div data-options="region:'north'" style="padding:20px 30px 12px;border:0">
					<p class="cenBtn">
						<!--  空一行，页面美观度-->
						<a class="btnG btnBl" id="moveMentExport">导出Excel</a>
					</p>
					
				</div>
				<!-- datagrid列表  -->
				<div data-options="region:'center'" style="padding:1px 30px 20px;border:0">
					<table id="move_list" width="100%"></table>
				</div>	
			</div>	 
...
<script type="text/javascript" src="<%=basePath %>/static/js/excelHead/moveMentHead.js"></script>
<script type="text/javascript" src="<%=basePath %>/static/js/movement/moveManage.js?v=0.10"></script>
