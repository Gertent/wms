...
.gList td input[type=checkbox]{margin-right:10px;}
</style>
</head>
<body class="easyui-layout">
	...
	<div class="goodsmBox smBox" data-options="region:'center'"
		...
		<div class="easyui-layout" data-options="fit:true">
			<div class="header" id="exceptionPackListSearch"
				data-options="region:'north'" style="border: 0">
				<p class="navBar mgB16">
					<a class="btnG btnBl" onclick="exceptionPackListSearchBox()">搜索</a>
				...
				<table class="gList">
					<tr>
						...
						<td>
						<label for="" class="dib tar">运单号</label><input
							class="easyui-validatebox combo" id="deliveryNo"
							name="deliveryNo" maxlength="20" />
						</td>
						...
						<input type="checkbox" id="orderEx" name="orderEx" />缺货
						<input type="checkbox" id="packEx" name="packEx" />异常</td>
					</tr>
				</table>
			</div>
				...
				<div class="easyui-layout" data-options="fit:true">
					<div data-options="region:'north'"
						...
						<p class="cenBtn">
							...
							<a class="btnG btnBl" id="exceptionPackExport">导出Excel</a>
						</p>
					...
					<div data-options="region:'center'"
						...
						<table id="exceptionPack_list" width="100%"></table>
					</div>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript"
			src="<%=basePath%>/static/js/excelHead/exceptionPackHead.js?v=0.01"></script>
	<script type="text/javascript"
		src="<%=basePath%>/static/js/outstock/exceptionPackManage.js?v=0.05"></script>
